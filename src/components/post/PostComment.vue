      ...
      <div v-if="isVisible" class="modal-overlay" @click.self="closeModal">
        <div class="modal-comment">
          ...
          <div class="modal-footer">
            ...
            <button
              class="btn ms-2"
              :class="commentText.trim() ? 'btn-post-active' : 'btn-post-disabled'"
              @click="addComment"
      ...
      comments: [
        {
          name: "Thao Le",
          text:
            "very nice, beautiful way peaceful nature and culture of peaceful river tourism",
        },
        {
          name: "Lan Hoang",
          text:
            "Can you help me know more about activities like fishing or visiting local markets to get a better idea of ​​the experience?",
        },
      ],
    };
  },
