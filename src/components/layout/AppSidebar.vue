    ...
    <div :class="[
      ...
      <ul class="nav flex-column">
        <li class="nav-item d-flex align-items-center hover">
          ...
          <a href="#" class="nav-link" :class="{ 'text-white': isDarkMode, 'text-dark': !isDarkMode }">Home</a>
        </li>

        <li class="nav-item d-flex align-items-center hover">
          <i class="fa-solid fa-person-military-to-person"></i>
          <a href="/friend" class="nav-link" :class="{ 'text-white': isDarkMode, 'text-dark': !isDarkMode }">Friends</a>
        </li>
        ...
        <li class="nav-item d-flex align-items-center hover">
          ...
          <a href="#" class="nav-link" :class="{ 'text-white': isDarkMode, 'text-dark': !isDarkMode }">Events</a>
        </li>
      </ul>
